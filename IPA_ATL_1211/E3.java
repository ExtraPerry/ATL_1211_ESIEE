...
if(pOp != 'c' && pOp != 'p'){//Anything but 'c' & 'p'. Also pX1 & pY1 coords. 		 				  		 				   
    ...
    int CoordX_1 = (int)Cosinus_1+center;//Translate coords for use in the canvas. 		 				  		 				   
    int CoordY_1 = (int)Sinus_1+center;//Translate coords for use in the canvas. 		 				  		 				   
...
if(pOp != 'b' && pOp != '1'){//Anything but 'b' & '1'. Also pX2 & pY2 coords. 		 				  		 				   
    ...
    int CoordX_2 = (int)Cosinus_2+center;//Translate coords for use in the canvas. 		 				  		 				   
    int CoordY_2 = (int)Sinus_2+center;//Translate coords for use in the canvas. 		 				  		 				   
...
switch(pAff){ 		 				  		 				   
    case 'a'://pX & pY (algébrique). 		 				  		 				   
        ...
        int CoordX_3 = (int)Cosinus_3+center;//Translate coords for use in the canvas. 		 				  		 				   
        int CoordY_3 = (int)Sinus_3+center;//Translate coords for use in the canvas. 		 				  		 				   
    ...
    case 'e'://pM & pA (exponentiel). 		 				  		 				   
        ...
        int CoordX_4 = (int)Cosinus_4+center;//Translate coords for use in the canvas. 		 				  		 				   
        int CoordY_4 = (int)Sinus_4+center;//Translate coords for use in the canvas. 		 				  		 				   
